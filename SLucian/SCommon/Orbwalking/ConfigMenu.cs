...
namespace SCommon.Orbwalking
{
    public class ConfigMenu
    {
        ...
        public ConfigMenu(Orbwalker instance, Menu menuToAttach)
        {
            ...
            m_Menu = new Menu("Orbwalking", String.Format("Orbwalking{0}.Root", m_orbInstance.GetHashCode()));
            ...
            m_Menu.AddItem(new MenuItem(String.Format("Orbwalking{0}.Root.blLastHit", m_orbInstance.GetHashCode()), "Last Hit").SetValue(new KeyBind('X', KeyBindType.Press)));
            m_Menu.AddItem(new MenuItem(String.Format("Orbwalking{0}.Root.blHarass", m_orbInstance.GetHashCode()), "Harass").SetValue(new KeyBind('C', KeyBindType.Press)));
            m_Menu.AddItem(new MenuItem(String.Format("Orbwalking{0}.Root.blLaneClear", m_orbInstance.GetHashCode()), "Lane Clear").SetValue(new KeyBind('V', KeyBindType.Press)));
            m_Menu.AddItem(new MenuItem(String.Format("Orbwalking{0}.Root.blCombo", m_orbInstance.GetHashCode()), "Combo").SetValue(new KeyBind(32, KeyBindType.Press)));
        ...
        public bool Combo
        {
            get { return m_Menu.Item(String.Format("Orbwalking{0}.Root.blCombo", m_orbInstance.GetHashCode())).GetValue<KeyBind>().Active; }
        }
        ...
        public bool Harass
        {
            get { return m_Menu.Item(String.Format("Orbwalking{0}.Root.blHarass", m_orbInstance.GetHashCode())).GetValue<KeyBind>().Active; }
        }
        ...
        {
            get { return m_Menu.Item(String.Format("Orbwalking{0}.Root.blLaneClear", m_orbInstance.GetHashCode())).GetValue<KeyBind>().Active; }
        }
        ...
        public bool LastHit
        {
            get { return m_Menu.Item(String.Format("Orbwalking{0}.Root.blLastHit", m_orbInstance.GetHashCode())).GetValue<KeyBind>().Active; }
        }

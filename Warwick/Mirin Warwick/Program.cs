...
namespace Warwick
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat(ChampionName + " <font color='#ff3232'>the Blood Hunter</font> by Mirin Loaded!");
        ...
        private static void DrawingOnOnEndScene(EventArgs args)
        {
            if (E.Level > 0)
            {
                ...
                if (eMini.Active)
                {
                    Utility.DrawCircle(ObjectManager.Player.Position, E.Range, eMini.Color, 1, 23, true);
                }
            }
        ...
        private static void Game_OnUpdate(EventArgs args)
        {
            ...
            if (Orbwalker.ActiveMode != Orbwalking.OrbwalkingMode.Combo)
            {
                    ...
                    Config.Item("Auto.Q.UseQHpMinHp").GetValue<Slider>().Value > Player.HealthPercent)
                {
                    ...
                    {
                        if (enemyObjects[0] is Obj_AI_Hero && Config.Item("Auto.Q.UseQHpEnemyUn").GetValue<bool>() &&
                            (enemyObjects[0] as Obj_AI_Hero).UnderTurret())
                            return;
        ...
        private static Obj_AI_Hero UseWforAlly
        {
            get
            {
                return
        ...
        public static int GetClosesAlliesToEnemy(Obj_AI_Hero t)
        {
                    ...
                    case 2:
                    {
                        if (tR.IsValidTarget(R.Range) &&
                            ...
                            (Q.IsReady() ||
                             ...
                             Player.Mana > Player.Spellbook.GetSpell(SpellSlot.Q).ManaCost + Player.Spellbook.GetSpell(SpellSlot.R).ManaCost
